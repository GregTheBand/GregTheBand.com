...
SI.Sizes = {
	...
	SI.Sizes.playerScale = 1.0; // adjust this number
	SI.Sizes.playerShipWidth = 60 * SI.Sizes.modifier * SI.Sizes.playerScale;
	SI.Sizes.playerShipHeight = 60 * SI.Sizes.modifier * SI.Sizes.playerScale;
	...
	SI.Sizes.font = 14 * SI.Sizes.modifier + 'px Arial';
...
SI.Images.playerImg.width = 60;
SI.Images.playerImg.height = 60;
